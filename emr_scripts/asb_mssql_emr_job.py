...
spark = (
    ...
    .config("spark.sql.catalog.uipl.warehouse",
            "s3://asb-s3-dev-bah-lakehouse-raw-01-urq47pi3/asb/bah/efts/")
...
etl_config = ETLConfig('asb-sm-dev-bah-lakehouse-efts-mssql-01-qihs6101', spark, 'NA', 'me-south-1', 
                       'asb_mssql_job_01', 'arn:aws:sns:me-south-1:136399769509:asb-sns-dev-bah-lakehouse-data-migration-alerts-01-psn10987', 'NA', 'NA',
                       'NA', 'asb_athena_dev_bah_lakehouse_framework_01', 'NA', 1,
                      'NA', 'NA',
                       'NA' ,'dasbbeftspro', 'asb-logs-dev-bah-lakehouse-efts-migration-logs-01-yfb18751',
                       'etl_master', 'audit_table', 'Asia/Bahrain', 'NA', 'NA', 'NA', 's3://asb-s3-dev-bah-lakehouse-temp-01-51ioql94/athena-query-results/')
